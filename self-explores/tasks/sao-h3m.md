...
type: task-worklog
task: sao-h3m
title: "Deep Dive: internal-comms"
status: open
detailed_at: 2026-03-26
detail_score: ready-for-dev
tags: [deep-dive, internal-comms, research]
---

# Deep Dive: internal-comms — Detailed Design

## 1. Objective
Nghiên cứu skill `internal-comms` (SKILL.md: 32 lines). Phân tích core logic, đánh giá chất lượng, viết analysis theo format chuẩn.
...
## 3. Input / Output
**Input:**
- `skills/internal-comms/SKILL.md` (32 lines)
- Extra files: examples/ (3P update, newsletter, FAQ, general comms templates)

**Output:**
- `self-explores/learn/internal-comms/analysis.md` (>= 30 lines)
...
Dùng Read tool: `skills/internal-comms/SKILL.md`
...
examples/ (3P update, newsletter, FAQ, general comms templates)
...
Focus areas: Template patterns for internal communications, tone/format guidelines, example quality assessment, 3P update structure, newsletter format
...
- SKILL.md: 32 lines
- Extra resources: examples/ (3P update, newsletter, FAQ, general comms templates)
- Focus: Template patterns for internal communications, tone/format guidelines, example quality assessment, 3P update structure, newsletter format
